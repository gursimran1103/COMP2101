...
#Quietly downloading a tarfile of pictures to our picture directory if it isn't there
...
#Testing if the tarfile is there then extracting the tarfile in the pictures directory then removing the local copy of tarfile
