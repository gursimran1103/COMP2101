...
# TASK 1 Displying Setgid files
echo "Setgid files:"
echo "==========================="
#Finding Setgid files in the system with the executable permission and redirecting errors to blackhole and sorting the files
find / -type f -executable -perm -2000 -ls 2>/dev/null | sort -k 3

#TASK 2 Largest files in the system
echo "Displying 10 Largest resgular files in the system sorted by their sizes"
echo "============================================================================================================="
#Finding files in the system and listing all of them in human readable format and Displying the sizes in MB then Sorting and Displying the first 10 largest files
#using sort and head command then awk command is used to print filename, Owner and Size Which is output of whole command
